# Joel Hägvall - Software Engineer Based in Stockholm, Sweden

> Software engineer based in Stockholm, Sweden, working across TypeScript, React, .NET/C#, developer tooling, workflow automation and AI products.

I'm a software engineer building enterprise systems, developer tooling, workflow automation and privacy-focused AI products.

## Work with me

I build RAG assistants, embeddings/vector search, document ingestion, AI reports, recommender flows, and the SaaS layer around them. Useful AI, connected to real data, shipped with auth, billing, audit logs, tests, and deployment. See [Work With Me](https://joelhagvall.com/work-with-me) or email work@joelhagvall.com.
